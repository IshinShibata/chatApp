...
func (cc *ChatCreate) SetImage(s string) *ChatCreate {
	cc.mutation.SetImage(s)
	return cc
}

// SetNillableImage sets the "image" field if the given value is not nil.
func (cc *ChatCreate) SetNillableImage(s *string) *ChatCreate {
	if s != nil {
		cc.SetImage(*s)
	}
	return cc
...
func (cc *ChatCreate) SetAuthorID(id int) *ChatCreate {
	cc.mutation.SetAuthorID(id)
	return cc
}

// SetNillableAuthorID sets the "author" edge to the User entity by ID if the given value is not nil.
func (cc *ChatCreate) SetNillableAuthorID(id *int) *ChatCreate {
	if id != nil {
...
func (cc *ChatCreate) SetAuthor(u *User) *ChatCreate {
...
func (cc *ChatCreate) check() error {
	...
	if _, ok := cc.mutation.Image(); !ok {
		return &ValidationError{Name: "image", err: errors.New(`ent: missing required field "Chat.image"`)}
	}
	return nil
}
